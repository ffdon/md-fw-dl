...
url: "http://firmware.ffdon.de/{{parse(downloadableSite).id}}/versions/v{{parse(downloadableSite).version}}/{{selectedMode}}/gluon-ffdon{{parse(downloadableSite).short}}-v" +
